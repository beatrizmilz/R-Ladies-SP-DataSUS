...
```{r}
cid10_x3 <- tibble::tibble(cid10 = character(), cid10_name = character()) %>%
  
  tibble::add_row(cid10 = "X30", cid10_name = "Exposição a Calor Natural Excessivo") %>%
  tibble::add_row(cid10 = "X31", cid10_name = "Exposição a Frio Natural Excessivo")  %>% 
  tibble::add_row(cid10 = "X32", cid10_name = "Exposição à Luz Solar") %>%
  tibble::add_row(cid10 = "X33", cid10_name = "Vítima de Raio") %>% 
  tibble::add_row(cid10 = "X34", cid10_name = "Vítima de Terremoto") %>% 
  tibble::add_row(cid10 = "X35", cid10_name = "Vítima de Erupção Vulcânica") %>% 
  tibble::add_row(cid10 = "X36", cid10_name = "Vítima de Avalanche, Desabamento de Terra e Outros Movimentos da Superfície Terrestre") %>% 
  tibble::add_row(cid10 = "X37", cid10_name = "Vítima de Tempestade Cataclísmica") %>%
  tibble::add_row(cid10 = "X38", cid10_name = "Vítima de Inundação") %>%
  tibble::add_row(cid10 = "X39", cid10_name = "Exposição a Outras Forças da Natureza e às Não Especificadas")
